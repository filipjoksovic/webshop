            ...
            <form class="neumorphic-form" action="../controllers/CheckoutController.php" method="POST">
                <div id="contact-form" class="neumorphic-form">
                    <div class="neumorphic-input-container">
                        <input id="fname" type="text" class="neumorphic-input" name="first_name" required="required">
                        <label class="neumorphic-label">Ime</label>
                    </div>
                    <div class="neumorphic-input-container ">
                        <input id="lname" type="text" class="neumorphic-input" name="last_name" required="required">
                        <label for="lname" class="neumorphic-label">Prezime</label>
                    </div>
                    <div class="row">
                        <div class="neumorphic-input-container col-md-6">
                            <input id="address" type="text" class="neumorphic-input" name="address" required="required">
                            <label for="address" class="neumorphic-label">Adresa</label>
                        </div>
                        <div class="neumorphic-input-container col-md-6">
                            <input id="zcode" type="text" class="neumorphic-input" name="zip_code" required="required">
                            <label for="zcode" class="neumorphic-label">Postanski broj</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="neumorphic-input-container col-md-6">
                            <input id="city" type="text" class="neumorphic-input" name="city" required="required">
                            <label for="city" class="neumorphic-label">Grad</label>
                        </div>

                        <div class="neumorphic-input-container col-md-6">
                            <input id="country" type="text" class="neumorphic-input" name="country" required="required">
                ...
                <div id="card-form" class="neumorphic-form">
                    <div class="neumorphic-input-container ">
                        <input id="card-name" type="text" class="neumorphic-input" name="card_name" required="required">
                        <label for="card-name" class="neumorphic-label">Ime i prezime vlasnika</label>
                    </div>
                    <div class="row">
                        <div class="neumorphic-input-container col-md-6">
                            <input id="cardExpire" type="text" class="neumorphic-input" name="card_expire" placeholder="MM/YY" required="required">
                            <label for="cardExpire" class="neumorphic-label">Datum isteka</label>
                        </div>
                        <div class="neumorphic-input-container col-md-6">
                            <input id="cvc" type="text" class="neumorphic-input" name="cvc_code" required="required">
